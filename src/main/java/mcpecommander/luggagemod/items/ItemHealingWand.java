...
public class ItemHealingWand extends Item {
	...
	public ItemHealingWand() {
		this.setRegistryName(Reference.LuggageModItems.HEALINGWAND.getRegistryName());
		this.setUnlocalizedName(Reference.LuggageModItems.HEALINGWAND.getUnlocalizedName());
	...
	public void onUsingTick(ItemStack stack, EntityLivingBase player, int count) {
		if(count % 3 == 0 && player.world.isRemote){
			...
			player.world.spawnParticle(EnumParticleTypes.SPELL_MOB, player.posX + (x * 0.8D), player.posY + player.getEyeHeight() + y, player.posZ + (z * 0.8D), d0, d1, d2);
		}
	}

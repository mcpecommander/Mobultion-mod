...
public class PotionJokerness extends Potion{
	...
	public void performEffect(EntityLivingBase entityLivingBaseIn, int amplifier) {
		if(entityLivingBaseIn instanceof EntityPlayer && entityLivingBaseIn.isPotionActive(ModPotions.potionJokerness)){
			this.isReady = true;
		}
	}
		...
		if (minecraft.gameSettings.thirdPersonView == 0) {
				...
				if(flag){
					...
					ingameGui.drawModalRectWithCustomSizedTexture(0 + rand1,
							0 + rand2, 0, 0, 16, 16, 16, 64);				
					GlStateManager.color(rand6, 0F, 0F, alpha);
					ingameGui.drawModalRectWithCustomSizedTexture(0 + rand4,
							0 + rand5, 0, 16, 16, 16, 16, 64);
					GlStateManager.color(rand9, 0F, 0F, alpha);
					ingameGui.drawModalRectWithCustomSizedTexture(0 + rand7,
							0 + rand8, 0, 32, 16, 16, 16, 64);
					GlStateManager.color(rand12, 0F, 0F, alpha);
					ingameGui.drawModalRectWithCustomSizedTexture(0 + rand10,
							0 + rand11, 0, 48, 16, 16, 16, 64);
...
//		Gui ingameGui = Minecraft.getMinecraft().ingameGUI;
//		minecraft.getTextureManager().bindTexture(TEX2);
//		GlStateManager.color(RNG.nextFloat(), 0F, 0F, 0.40F + (RNG.nextFloat() * 0.6F));
//		ingameGui.drawModalRectWithCustomSizedTexture(0 + RNG.nextInt(scaledRes.getScaledWidth()),
//				0 + RNG.nextInt(scaledRes.getScaledHeight()), 0, (RNG.nextInt(3) * 16), 16, 16, 16, 64);
//	}
...
//		ingameGui.drawModalRectWithCustomSizedTexture(0 + rand1, 0 + rand2, 0, rand3, 16, 16, 16, 64);
//		GlStateManager.color(RNG.nextFloat(), 0F, 0F, 0.40F + 0.4f);
//		ingameGui.drawModalRectWithCustomSizedTexture(0 + (rand1 += (RNG.nextBoolean() ? 10 : -10)), 0 + (rand2 += (RNG.nextBoolean() ? 10 : -10)), 0, rand3, 16, 16, 16, 64);
...
//		ingameGui.drawModalRectWithCustomSizedTexture(0 + rand1 + (right ? -16 : 16), 0 + rand2 + (down ? -16 : 16), 0, rand3, 16, 16, 16, 64);
//		GlStateManager.color(RNG.nextFloat(), 0F, 0F, alpha - 0.4f);
//		ingameGui.drawModalRectWithCustomSizedTexture(0 + rand1 + (right ? -32 : 32), 0 + rand2 + (down ? -32 : 32), 0, rand3, 16, 16, 16, 64);
//		GlStateManager.color(RNG.nextFloat(), 0F, 0F, alpha - 0.6f);
//		ingameGui.drawModalRectWithCustomSizedTexture(0 + rand1 + (right ? -48 : 48), 0 + rand2 + (down ? -48 : 48), 0, rand3, 16, 16, 16, 64);
//		GlStateManager.color(RNG.nextFloat(), 0F, 0F, alpha - 0.8f);
//		ingameGui.drawModalRectWithCustomSizedTexture(0 + rand1 + (right ? -64 : 64), 0 + rand2 + (down ? -64 : 64), 0, rand3, 16, 16, 16, 64);
//
//	}

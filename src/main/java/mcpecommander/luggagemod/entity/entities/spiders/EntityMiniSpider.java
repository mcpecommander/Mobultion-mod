...
import mcpecommander.luggagemod.entity.entityAI.spidersAI.miniAI.EntityAIMiniSpiderAttack;
import mcpecommander.luggagemod.entity.entityAI.spidersAI.miniAI.EntityAIMiniSpiderTarget;
...
public class EntityMiniSpider extends EntityAnimatedSpider{
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(MobsConfig.spiders.mini.speed);

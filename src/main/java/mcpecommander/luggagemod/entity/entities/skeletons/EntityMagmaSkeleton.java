...
import mcpecommander.luggagemod.particle.ColoredLavaParticle;
...
public class EntityMagmaSkeleton extends EntityAnimatedSkeleton{
    ...
    static {
    	EntityMagmaSkeleton.animHandler.addAnim(Reference.MOD_ID, "skeleton_death", "forest_skeleton", false);
    	EntityMagmaSkeleton.animHandler.addAnim(Reference.MOD_ID, "skeleton_walk", "forest_skeleton", true);
    	EntityMagmaSkeleton.animHandler.addAnim(Reference.MOD_ID, "skeleton_walk_hands", "forest_skeleton", true);
    	EntityMagmaSkeleton.animHandler.addAnim(Reference.MOD_ID, "skeleton_holding_bow", "forest_skeleton", true);
    	EntityMagmaSkeleton.animHandler.addAnim(Reference.MOD_ID, "lookat", new AnimationLookAt("Head"));
    	EntityMagmaSkeleton.animHandler.addAnim(Reference.MOD_ID, "riding", new AnimationRiding());
    }

	public EntityMagmaSkeleton(World worldIn) {
		super(worldIn);
	...
	public void attackEntityWithRangedAttack(EntityLivingBase target, float distanceFactor)
    {
        ...
        entityarrow.setThrowableHeading(d0, d1 + d3 * 0.20000000298023224D, d2, 1.6F, 14f);
	...
	protected EntityArrow getArrow(float distanceFactor) {
		EntityMagmaArrow arrow = new EntityMagmaArrow(this.world, this);

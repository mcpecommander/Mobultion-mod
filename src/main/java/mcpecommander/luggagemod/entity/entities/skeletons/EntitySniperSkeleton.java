...
import mcpecommander.luggagemod.entity.entityAI.skeletonsAI.EntityAIAttackRangedModBow;
import mcpecommander.luggagemod.entity.entityAI.skeletonsAI.EntityAIForestSkeletonMoveToTree;
...
public class EntitySniperSkeleton extends EntityAnimatedSkeleton{
	...
	protected void initEntityAI() {
	    ...
	    this.tasks.addTask(2, new EntityAIForestSkeletonMoveToTree(this, 20, 1.0D));
	...
	public void attackEntityWithRangedAttack(EntityLivingBase target, float distanceFactor)
    {
        ...
        entityarrow.setThrowableHeading(d0, d1 + d3 * 0.20000000298023224D, d2, 1.6F, 0f);
	...
	protected EntityArrow getArrow(float distanceFactor) {
		...
		arrow.addEffect(new PotionEffect(MobEffects.POISON, 100, 0, false, true));
		return arrow;
	}

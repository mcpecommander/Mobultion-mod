...
public class EntityWitheringSkeleton extends EntityAnimatedSkeleton{
	...
	private final EntityAIAttackRangedBow<EntityWitheringSkeleton> aiArrowAttack = new EntityAIAttackRangedBow<EntityWitheringSkeleton>(this, 1.0D, 20, 15.0F);
	...
	protected EntityArrow getArrow(float distanceFactor) {
		...
		arrow.addEffect(new PotionEffect(MobEffects.WITHER, 100, 0, false, true));
		return arrow;
	}

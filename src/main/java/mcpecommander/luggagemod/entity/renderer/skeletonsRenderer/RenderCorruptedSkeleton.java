...
public class RenderCorruptedSkeleton<T extends EntityCorruptedSkeleton> extends RenderLiving<T>
{
    ...
    public RenderCorruptedSkeleton(RenderManager manager) {
    ...
    @Override
	protected void applyRotations(EntityCorruptedSkeleton entityLiving, float p_77043_2_, float rotationYaw, float partialTicks) {
	...
	@Override
	protected boolean setBrightness(EntityCorruptedSkeleton entitylivingbaseIn, float partialTicks, boolean combineTextures) {
    ...
    protected ResourceLocation getEntityTexture(T entity) {
        return new ResourceLocation(Reference.MOD_ID, "textures/entity/corrupted_skeleton.png");
    }

    public static class Factory<T extends EntityCorruptedSkeleton> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderCorruptedSkeleton(manager);
        }
    }
}
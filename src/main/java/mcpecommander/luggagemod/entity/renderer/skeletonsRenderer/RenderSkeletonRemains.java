...
public class RenderSkeletonRemains extends RenderLivingBase<EntitySkeletonRemains>{
	...
	public ResourceLocation mobTexture = new ResourceLocation("mlm:textures/entity/withering_skeleton.png");
	public ResourceLocation mobTexture2 = new ResourceLocation("mlm:textures/entity/volcanic_skeleton.png");
	public ResourceLocation mobTexture3 = new ResourceLocation("mlm:textures/entity/forest_skeleton.png");
	public ResourceLocation mobTexture4 = new ResourceLocation("mlm:textures/entity/joker_skeleton.png");
	public ResourceLocation mobTexture5 = new ResourceLocation("mlm:textures/entity/corrupted_skeleton.png");
	...
	@Override
	protected void applyRotations(EntitySkeletonRemains entityLiving, float p_77043_2_, float rotationYaw, float partialTicks) {
	...
	@Override
	protected boolean setBrightness(EntitySkeletonRemains entitylivingbaseIn, float partialTicks, boolean combineTextures) {

...
public class RenderWitheringSkeleton<T extends EntityWitheringSkeleton> extends RenderLiving<T>
{
    ...
    public RenderWitheringSkeleton(RenderManager manager) {
    ...
    @Override
	protected void applyRotations(EntityWitheringSkeleton entityLiving, float p_77043_2_, float rotationYaw, float partialTicks) {
	...
	@Override
	protected boolean setBrightness(EntityWitheringSkeleton entitylivingbaseIn, float partialTicks, boolean combineTextures) {
    ...
    protected ResourceLocation getEntityTexture(T entity) {
        return new ResourceLocation(Reference.MOD_ID, "textures/entity/withering_skeleton.png");
    }

    public static class Factory<T extends EntityWitheringSkeleton> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderWitheringSkeleton(manager);
        }
    }
}
...
import mcpecommander.luggagemod.entity.layers.spiderLayers.LayerSorcererSpiderEyes;
...
public class RenderSorcererSpider extends RenderLiving<EntitySorcererSpider>{
	...
	public ResourceLocation mobTexture = new ResourceLocation("mlm:textures/entity/sorcerer_spider.png");

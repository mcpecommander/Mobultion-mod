...
import mcpecommander.luggagemod.entity.layers.spiderLayers.LayerAngelSpiderRing;
...
public class RenderAngelSpider extends RenderLiving<EntityAngelSpider>{
	...
	public ResourceLocation mobTexture = new ResourceLocation("mlm:textures/entity/angel_spider.png");

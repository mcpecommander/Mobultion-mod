...
public class RenderDoctorZombie<T extends EntityDoctorZombie> extends RenderLiving<T>
{
    private static ModelCraftStudioSon model = new ModelCraftStudioSon(Reference.MOD_ID, "zombie", 64, 64);
    
    public RenderDoctorZombie(RenderManager manager) {
    ...
    protected ResourceLocation getEntityTexture(T entity) {
        return new ResourceLocation(Reference.MOD_ID, "textures/entity/doctor_zombie.png");
    }

    public static class Factory<T extends EntityDoctorZombie> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderDoctorZombie(manager);
        }
    }
}
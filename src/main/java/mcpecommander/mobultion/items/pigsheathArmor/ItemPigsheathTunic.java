...
public class ItemPigsheathTunic extends ItemArmor{

	public ItemPigsheathTunic() {
		super(CommonProxy.PIG_SHEATH, 1, EntityEquipmentSlot.CHEST);
		this.setRegistryName(Reference.MobultionItems.PIGSHEATHTUNIC.getRegistryName());
		this.setUnlocalizedName(Reference.MobultionItems.PIGSHEATHTUNIC.getUnlocalizedName());

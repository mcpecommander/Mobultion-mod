...
public class ItemPigsheathHelmet extends ItemArmor{

	public ItemPigsheathHelmet() {
		super(CommonProxy.PIG_SHEATH, 1, EntityEquipmentSlot.HEAD);
		this.setRegistryName(Reference.MobultionItems.PIGSHEATHHELMET.getRegistryName());
		this.setUnlocalizedName(Reference.MobultionItems.PIGSHEATHHELMET.getUnlocalizedName());

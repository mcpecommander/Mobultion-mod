...
public class PotionVomit extends Potion{

	private static final ResourceLocation VOMIT = new ResourceLocation(Reference.MOD_ID, "textures/potion/puke.png"); 
	...
	public void renderEffect(RenderGameOverlayEvent.Post e, float mul){
        ...
        Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation(Reference.MOD_ID, "textures/entity/vomit.png"));
	...
	private void render(int x, int y, float alpha) {
		Minecraft.getMinecraft().renderEngine.bindTexture(VOMIT);
		Tessellator tessellator = Tessellator.getInstance();

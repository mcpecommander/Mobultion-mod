...
public class EntityEnderFlake extends EntityThrowable{

    private EntityLivingBase pearlThrower;
    
	public EntityEnderFlake(World worldIn) {
		super(worldIn);
	}
	
	public EntityEnderFlake(World worldIn, EntityLivingBase throwerIn)
    {
    ...
    public EntityEnderFlake(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
        ...
        if (!this.world.isRemote)
        {
            if (entitylivingbase instanceof EntityPlayerMP)
            {
                ...
                if (entityplayermp.connection.getNetworkManager().isChannelOpen() && entityplayermp.world == this.world && !entityplayermp.isPlayerSleeping())
                {
                    ...
                    entitylivingbase.attackEntityFrom(DamageSource.FALL, 0.0f);

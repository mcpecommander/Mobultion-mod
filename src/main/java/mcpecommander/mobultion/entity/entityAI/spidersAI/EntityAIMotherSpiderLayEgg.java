	...
	public boolean shouldExecute() {
		if(this.entity != null && !this.entity.isDead){
			if(this.entity.getAttackTarget() != null){
				...
				return this.entity.getHealth() > 4f && this.entity.getRNG().nextInt(100) == 0 && this.coolDown-- <= 0;
			}
		}
		return false;
	}
	...
	public void updateTask() {
		if(this.averageTime-- <= 0){
            if(!this.world.isRemote){
				...
				egg.setLocationAndAngles(this.entity.posX, this.entity.posY, this.entity.posZ, this.entity.rotationYaw, 0.0F);

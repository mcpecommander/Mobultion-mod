...
public class EntityAIVampireMeleeAttack extends EntityAIBase
{
    World world;
    ...
    public EntityAIVampireMeleeAttack(EntityCreature creature, double speedIn, boolean useLongMemory)
    {
    ...
    public void resetTask()
    {
        ...
        ((EntityVampireSkeleton) this.attacker).setSwingingArms(false);
    }
    ...
    public void updateTask()
    {
		...
		if (d0 < 3d) {
			((EntityVampireSkeleton) this.attacker).setSwingingArms(true);
		} else {
			((EntityVampireSkeleton) this.attacker).setSwingingArms(false);
		}
    }

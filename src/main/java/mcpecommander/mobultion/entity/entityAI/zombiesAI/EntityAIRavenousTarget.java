...
public class EntityAIRavenousTarget extends EntityAITarget{

	private Class[] targets;
	private EntityLivingBase mainTarget;
	World world;
    private final EntityAIRavenousTarget.Sorter sorter;
	
	public EntityAIRavenousTarget(EntityCreature entity, boolean checkSight, Class... targets) {
		super(entity, checkSight);
		this.targets = targets;
		this.world = entity.world;
		this.sorter = new EntityAIRavenousTarget.Sorter(entity);
	}

...
public class EntityAIEndermanAttackMelee extends EntityAIBase
{
    World world;
    ...
    public EntityAIEndermanAttackMelee(EntityCreature creature, double speedIn, boolean useLongMemory)
    {
	...
	public void resetTask()
    {
        ...
        ((EntityIceEnderman) this.attacker).setBiting(false);
    }
	...
	public void updateTask()
    {
        ...
        if(d0 <= this.getAttackReachSqr(entitylivingbase) + 4){
        	((EntityIceEnderman) this.attacker).setBiting(true);
        }else{
        	((EntityIceEnderman) this.attacker).setBiting(false);
        }
    }

...
public class AnimationVanillaWalking extends CustomChannel {
	...
	/*
	 * this.bipedRightLeg.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) *
	 * 1.4F * limbSwingAmount / f; this.bipedLeftLeg.rotateAngleX =
	 * MathHelper.cos(limbSwing * 0.6662F + (float)Math.PI) * 1.4F *
	 * limbSwingAmount / f; this.bipedRightLeg.rotateAngleY = 0.0F;
	 * this.bipedLeftLeg.rotateAngleY = 0.0F; this.bipedRightLeg.rotateAngleZ =

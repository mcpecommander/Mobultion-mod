...
public class RenderRavenousZombie<T extends EntityRavenousZombie> extends RenderLiving<T>
{
    private static ModelCraftStudioSon model = new ModelCraftStudioSon(Reference.MOD_ID, "ravenous_zombie", 64, 64);
    
    public RenderRavenousZombie(RenderManager manager) {
    ...
    protected ResourceLocation getEntityTexture(T entity) {
        return new ResourceLocation(Reference.MOD_ID, "textures/entity/ravenous_zombie.png");
    }

    public static class Factory<T extends EntityRavenousZombie> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderRavenousZombie(manager);
        }
    }
}
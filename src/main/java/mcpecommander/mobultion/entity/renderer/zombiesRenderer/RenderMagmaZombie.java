...
import mcpecommander.mobultion.entity.layers.zombieLayers.LayerMagmaZombieLava;
...
public class RenderMagmaZombie<T extends EntityMagmaZombie> extends RenderLiving<T> {
	...
	protected ResourceLocation getEntityTexture(T entity) {
		return (entity.ticksExisted / 10) % 2 == 0
				? new ResourceLocation(Reference.MOD_ID, "textures/entity/magma_zombie/magma_zombie.png")
				: new ResourceLocation(Reference.MOD_ID, "textures/entity/magma_zombie/magma_zombie1.png");
	}

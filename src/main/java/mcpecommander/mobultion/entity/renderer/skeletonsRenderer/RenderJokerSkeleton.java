...
public class RenderJokerSkeleton<T extends EntityJokerSkeleton> extends RenderLiving<T>
{
    public static final Factory FACTORY = new Factory();
    private static final DynamicTexture TEXTURE_BRIGHTNESS = new DynamicTexture(16, 16);
    private static ModelCraftStudioSon model = new ModelCraftStudioSon(Reference.MOD_ID, "joker_skeleton", 64, 64);
    
    public RenderJokerSkeleton(RenderManager manager) {
...
//    	Matrix3f m = rotate(0, entity.rotationPitch, entity.getRotationYawHead());
//    	System.out.println(model.getModelRendererFromName("Head").boxName);
//    	model.getModelRendererFromName("Head").getRotationMatrix().set(m);
//    	model.getModelRendererFromName("Head").getRotationMatrix().transpose();
//    	System.out.println(model.getModelRendererFromName("Head").getRotationMatrix());
...
//    }
    ...
    @Override
	protected void applyRotations(EntityJokerSkeleton entityLiving, float p_77043_2_, float rotationYaw, float partialTicks) {
	...
	@Override
	protected boolean setBrightness(EntityJokerSkeleton entitylivingbaseIn, float partialTicks, boolean combineTextures) {
    ...
    protected ResourceLocation getEntityTexture(T entity) {
        return new ResourceLocation(Reference.MOD_ID, "textures/entity/joker_skeleton.png");
    }

    public static class Factory<T extends EntityJokerSkeleton> implements IRenderFactory<T>
    {
        @Override
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderJokerSkeleton(manager);
        }
    }
}
...
public class LayerShamanRobe implements LayerRenderer<EntityShamanSkeleton>
{
    private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID, "textures/entity/shaman_skeleton_overlay.png");
    private final RenderShamanSkeleton renderer;
    private final ModelCraftStudioSon layerModel;

    public LayerShamanRobe(RenderShamanSkeleton entityRender)
    {

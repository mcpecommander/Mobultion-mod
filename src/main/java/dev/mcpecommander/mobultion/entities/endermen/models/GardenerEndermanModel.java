...
public class GardenerEndermanModel extends AnimatedGeoModel<GardenerEndermanEntity> {
    /**
     ...
     */
    @Override
    public ResourceLocation getModelLocation(GardenerEndermanEntity entity) {
        return new ResourceLocation(MODID, "geo/endermen/gardenerenderman.json");
    }
     ...
     */
    @Override
    public ResourceLocation getTextureLocation(GardenerEndermanEntity entity) {
        return new ResourceLocation(MODID, "textures/entity/endermen/gardenerenderman.png");
    }
     ...
     */
    @Override
    public ResourceLocation getAnimationFileLocation(GardenerEndermanEntity animatable) {
        return new ResourceLocation(MODID, "animations/endermen/gardenerenderman.animation.json");
    }

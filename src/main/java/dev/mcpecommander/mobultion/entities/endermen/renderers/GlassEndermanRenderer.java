...
public class GlassEndermanRenderer extends GeoEntityRenderer<GlassEndermanEntity> {
    ...
    public GlassEndermanRenderer(EntityRendererProvider.Context renderManager) {
    ...
    @Override
    public RenderType getRenderType(GlassEndermanEntity animatable, float partialTicks, PoseStack stack,
     ...
     */
    @Override
    public Color getRenderColor(GlassEndermanEntity animatable, float partialTicks, PoseStack stack,
                                @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer vertexBuilder,
                                int packedLightIn) {

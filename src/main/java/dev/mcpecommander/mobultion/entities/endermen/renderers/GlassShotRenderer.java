...
public class GlassShotRenderer extends GeoProjectilesRenderer<GlassShotEntity> {
    ...
    public GlassShotRenderer(EntityRendererProvider.Context renderManager) {
    ...
    @Override
    public RenderType getRenderType(GlassShotEntity animatable, float partialTicks, PoseStack stack,
     ...
     */
    @Override
    public Color getRenderColor(GlassShotEntity animatable, float partialTicks, PoseStack stack,
                                @Nullable MultiBufferSource renderTypeBuffer, @Nullable VertexConsumer vertexBuilder,
                                int packedLightIn) {

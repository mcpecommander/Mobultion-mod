...
/* McpeCommander created on 07/07/2021 inside the package - dev.mcpecommander.mobultion.entities.endermen.models */
public class IceEndermanModel extends AnimatedGeoModel<IceEndermanEntity> {
    /**
     ...
     */
    @Override
    public ResourceLocation getModelLocation(IceEndermanEntity entity) {
        return new ResourceLocation(MODID, "geo/endermen/iceenderman.json");
    }
     ...
     */
    @Override
    public ResourceLocation getTextureLocation(IceEndermanEntity entity) {
        return new ResourceLocation(MODID, "textures/entity/endermen/iceenderman.png");
    }
     ...
     */
    @Override
    public ResourceLocation getAnimationFileLocation(IceEndermanEntity animatable) {
        return new ResourceLocation(MODID, "animations/endermen/iceenderman.animation.json");
    }
     ...
     */
    @Override
    public void setLivingAnimations(IceEndermanEntity entity, Integer uniqueID, @Nullable AnimationEvent customPredicate) {

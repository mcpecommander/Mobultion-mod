...
/* McpeCommander created on 31/07/2021 inside the package - dev.mcpecommander.mobultion.entities.zombies.entities */
public class GoroZombieEntity extends MobultionZombieEntity{

    private final AnimationFactory factory = new AnimationFactory(this);

    public GoroZombieEntity(EntityType<? extends MobultionZombieEntity> type, Level world) {
        super(type, world);
    }

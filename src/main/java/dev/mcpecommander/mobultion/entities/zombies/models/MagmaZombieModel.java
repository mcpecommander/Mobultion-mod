...
/* McpeCommander created on 29/07/2021 inside the package - dev.mcpecommander.mobultion.entities.zombies.models */
public class MagmaZombieModel extends AnimatedGeoModel<MagmaZombieEntity> {
     ...
     */
    @Override
    public ResourceLocation getModelLocation(MagmaZombieEntity entity) {
     ...
     */
    @Override
    public ResourceLocation getTextureLocation(MagmaZombieEntity entity) {
        return entity.tickCount % 20 >= 10 ? new ResourceLocation(MODID, "textures/entity/zombies/magmazombie.png") :
                new ResourceLocation(MODID, "textures/entity/zombies/magmazombie1.png");
    }
     ...
     */
    @Override
    public ResourceLocation getAnimationFileLocation(MagmaZombieEntity animatable) {
     ...
     */
    @Override
    public void setLivingAnimations(MagmaZombieEntity entity, Integer uniqueID, @Nullable AnimationEvent customPredicate) {

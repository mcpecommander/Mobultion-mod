...
public class HungryZombieEntity extends MobultionZombieEntity{
    ...
    public HungryZombieEntity(EntityType<? extends MobultionZombieEntity> type, Level world) {
        super(type, world);
    }
    ...
    protected void populateDefaultEquipmentSlots(@Nonnull DifficultyInstance difficulty) {
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(Registration.KNIFE.get()));
        this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(Registration.FORK.get()));
    }

    @Nullable
    @Override
    public SpawnGroupData finalizeSpawn(@Nonnull ServerLevelAccessor world, @Nonnull DifficultyInstance difficulty,

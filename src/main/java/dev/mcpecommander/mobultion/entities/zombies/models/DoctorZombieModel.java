...
public class DoctorZombieModel extends AnimatedGeoModel<DoctorZombieEntity> {
     ...
     */
    @Override
    public ResourceLocation getModelLocation(DoctorZombieEntity entity) {
     ...
     */
    @Override
    public ResourceLocation getTextureLocation(DoctorZombieEntity entity) {
        return new ResourceLocation(MODID, "textures/entity/zombies/doctorzombie.png");
    }
     ...
     */
    @Override
    public ResourceLocation getAnimationFileLocation(DoctorZombieEntity animatable) {
     ...
     */
    @Override
    public void setLivingAnimations(DoctorZombieEntity entity, Integer uniqueID, @Nullable AnimationEvent customPredicate) {

...
public class GoroZombieRenderer extends GeoEntityRenderer<GoroZombieEntity> {
    ...
    public GoroZombieRenderer(EntityRendererProvider.Context renderManager) {
    ...
    @Override
    public void render(GeoModel model, GoroZombieEntity animatable, float partialTicks, RenderType type, PoseStack matrixStackIn,

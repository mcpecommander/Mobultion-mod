...
public class KnightZombieModel extends AnimatedGeoModel<KnightZombieEntity> {
     ...
     */
    @Override
    public ResourceLocation getModelLocation(KnightZombieEntity entity) {
     ...
     */
    @Override
    public ResourceLocation getTextureLocation(KnightZombieEntity entity) {
        return new ResourceLocation(MODID, "textures/entity/zombies/knightzombie.png");
    }
     ...
     */
    @Override
    public ResourceLocation getAnimationFileLocation(KnightZombieEntity animatable) {
     ...
     */
    @Override
    public void setLivingAnimations(KnightZombieEntity entity, Integer uniqueID, @Nullable AnimationEvent customPredicate) {

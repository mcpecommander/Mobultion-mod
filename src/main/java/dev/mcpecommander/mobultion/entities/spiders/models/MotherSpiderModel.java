...
public class MotherSpiderModel extends AnimatedGeoModel<MotherSpiderEntity> {
     ...
     */
    @Override
    public ResourceLocation getModelLocation(MotherSpiderEntity entity) {
        return new ResourceLocation(MODID, "geo/spiders/motherspider.json");
    }
     ...
     */
    @Override
    public ResourceLocation getTextureLocation(MotherSpiderEntity entity) {
        return new ResourceLocation(MODID, "textures/entity/spiders/motherspider.png");
    }
     ...
     */
    @Override
    public ResourceLocation getAnimationFileLocation(MotherSpiderEntity animatable) {
        return new ResourceLocation(MODID, "animations/spiders/motherspider.animation.json");
    }
     ...
     */
    @Override
    public void setLivingAnimations(MotherSpiderEntity entity, Integer uniqueID, @Nullable AnimationEvent customPredicate) {

...
public class SkeletonsConfig {
    ...
    public static void setupSkeletonsConfig(ForgeConfigSpec.Builder serverBuilder){
        ...
        CORRUPTED_SPEED = serverBuilder.comment("Corrupted Skeleton movement speed").defineInRange("speed", 0.25d, 0.1d, 2d);
        ...
        FOREST_HEALTH = serverBuilder.comment("Forest Skeleton max health").defineInRange("health", 16d, 1d, 300d);
        FOREST_SPEED = serverBuilder.comment("Forest Skeleton movement speed").defineInRange("speed", 0.25d, 0.1d, 2d);
        FOREST_DAMAGE = serverBuilder.comment("Forest Skeleton ranged damage").defineInRange("damage", 3d, 0d, 40d);
        FOREST_RADIUS = serverBuilder.comment("Forest Skeleton follow range").defineInRange("range", 36, 4, 200);
        ...
        JOKER_SPEED = serverBuilder.comment("Joker Skeleton movement speed").defineInRange("speed", 0.3d, 0.1d, 2d);
        ...
        MAGMA_SPEED = serverBuilder.comment("Magma Skeleton movement speed").defineInRange("speed", 0.25d, 0.1d, 2d);
        ...
        SHAMAN_SPEED = serverBuilder.comment("Shaman Skeleton movement speed").defineInRange("speed", 0.28d, 0.1d, 2d);
        ...
        VAMPIRE_SPEED = serverBuilder.comment("Vampire Skeleton movement speed").defineInRange("speed", 0.25d, 0.1d, 2d);

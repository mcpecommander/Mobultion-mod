...
public class JokerSkeletonRenderer extends GeoEntityRenderer<JokerSkeletonEntity> {
    ...
    public JokerSkeletonRenderer(EntityRendererProvider.Context renderManager) {
    ...
    @Override
    protected void applyRotations(JokerSkeletonEntity entityLiving, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
    ...
    @Override
    public void render(GeoModel model, JokerSkeletonEntity animatable, float partialTicks, RenderType type, PoseStack matrixStackIn,

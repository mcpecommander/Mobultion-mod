...
public class HealingStaffItem extends Item implements IAnimatable, ISyncable {
    ...
    public HealingStaffItem() {
        super(new Properties().tab(ModSetup.ITEM_GROUP).setNoRepair().stacksTo(1).durability(100).setISTER(() -> HealingStaffRenderer::new));
        GeckoLibNetwork.registerSyncable(this);
    }

    @Override
    public void inventoryTick(ItemStack itemStack, World world, Entity holder, int slotNumber, boolean isSelected) {

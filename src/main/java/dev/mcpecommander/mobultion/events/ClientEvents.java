...
//            Registration.HALO.get().getItemStackTileEntityRenderer().renderByItem(event.getEntity().getItemBySlot(EquipmentSlot.HEAD),
//                    ItemTransforms.TransformType.HEAD, event.getMatrixStack(), event.getBuffers(), event.getLight(), 0);
//            stack.popPose();
//        }
//    }
//
